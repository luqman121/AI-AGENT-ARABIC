...
export const FILE_ARTIFACT_PROMPT_VERSION = "file-artifact.ar.v3";
...
export function buildFileArtifactPrompt(input: {
  ...
  return {
    ...
    developer: [
      ...
      "لا تضع نصوص تعبئة مثل «أدخل الرقم هنا» أو «أضف القيمة هنا». إذا لم يقدّم المستخدم قيمة لازمة، اكتب بوضوح أنها غير متوفرة في المدخلات الحالية دون إنشاء موضع تعبئة وهمي.",
